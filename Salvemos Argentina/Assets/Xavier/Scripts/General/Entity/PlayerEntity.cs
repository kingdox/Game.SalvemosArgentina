...
public class PlayerEntity : ComponentBase
{
    ...
    [SerializeField] private RotationController ctrl_rotate_player_left = default;
    [SerializeField] private RotationController ctrl_rotate_player_right = default;
    #endregion
    #region Event
    private void Start(){
        RefreshUiBullets();
    ...
    private void FixedUpdate() => ctrl_commands.CheckFixedUpdate();
    #endregion
    #region Methods
    ...
    public void Rotate_Left() => ctrl_rotate_player_left.Rotate();
    public void Rotate_Right() => ctrl_rotate_player_right.Rotate();
    public void Shoot(){
        if (ctrl_value_canShoot.Value){
            ...
            } else AudioSystem.PlaySound(GeneralSounds.SHOT_NO_BULLETS);
        }
        else AudioSystem.PlaySound(GeneralSounds.SHOT_NO_BULLETS);
    }
